...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "tapan01-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ax01"
  #   chef.validation_client_name = "ax01-validator"
  #   chef.validation_key_path = ".chef/ax01-validator.pem"
  # end
end
